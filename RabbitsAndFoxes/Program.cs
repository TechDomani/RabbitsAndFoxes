...
namespace PredatorPrey
{
    ...
    class Location
    {
        ...
        public Char Terrain { get; private set; }
    ...
    class Simulation
    {
        ...
        {
            int Coordinate;
            string message = "  Input " + Coordinatename + " coordinate: ";
            do
            {               
                Console.Write(message);
                Coordinate = Convert.ToInt32(Console.ReadLine());
                message = "Coordinate is outside of landscape, please try again.";
        ...
        private void CreateLandscapeAndAnimals(int InitialWarrenCount, int InitialFoxCount, bool FixedInitialLocations)
        {
            for (int x = 0; x < LandscapeSize; x++)
            {
                for (int y = 0; y < LandscapeSize; y++)
                {
                    ...
                    Landscape[x, y] = new Location(terrain);
                }
            }
        ...
        private void CreateNewWarren()
        {
            ...
            } while (Landscape[x, y].Warren != null || Landscape[x, y].Terrain == 'R');
            if (ShowDetail)
            {
        ...
        private void CreateNewFox()
        {
            ...
            do
            {
                x = Rnd.Next(0, LandscapeSize);
                y = Rnd.Next(0, LandscapeSize);
            } while (Landscape[x, y].Fox != null || Landscape[x, y].Terrain == 'R');
            if (ShowDetail)
            {
        ...
        private bool CheckIfPathCrossesRiver(int foxX, int foxY, int warrenX, int warrenY)
        {
            int startX = foxX < warrenX ? foxX : warrenX;
            int endX = foxX < warrenX ? warrenX: foxX;
            ...
            int startY = foxY < warrenY ? foxY : warrenY;
            int endY = foxY < warrenY ? warrenY : foxY;
        ...
        private void FoxesEatRabbitsInWarren(int WarrenX, int WarrenY)
        {
            ...
            for (int FoxX = 0; FoxX < LandscapeSize; FoxX++)
            {
                ...
                {
                    if (Landscape[FoxX, FoxY].Fox != null && !CheckIfPathCrossesRiver(FoxX, FoxY, WarrenX, WarrenY))
                    {
    ...
    class Rabbit : Animal
    {
        ...
        public override void CalculateNewAge()
        {
            ...
            if (IsAlive)
            {
                ...
                else if (Gender == Genders.Female && Age >= 2)
                {
